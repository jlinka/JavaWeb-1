...
<!DOCTYPE>
<%
String user =request.getParameter("aid");
...
<head>
	<meta charset="UTF-8">
	<title>管理员登录 - Unreal Lipstick Store - 不存在的唇膏店</title>
...
<body>
	...
	<script src='js/index-bg.js' type="text/javascript"></script>
      ...
      <form name="form1" action="adminLoginSave.jsp" method="post" onsubmit="return check()">
